/**
 * Upload the four Met Gala 2026 craft blog images to Cloudinary.
 *
 * Usage:
 *   CLOUDINARY_CLOUD_NAME=dn9snfizy \
 *   CLOUDINARY_API_KEY=... \
 *   CLOUDINARY_API_SECRET=... \
 *   node scripts/upload-met-gala.mjs
 */
...
const images = [
    { file: "blog/met_gala_craft_hero.png", publicId: "blog/met_gala_craft_hero" },
    { file: "blog/met_gala_craft_hours.png", publicId: "blog/met_gala_craft_hours" },
    { file: "blog/met_gala_craft_techniques.png", publicId: "blog/met_gala_craft_techniques" },
    { file: "blog/met_gala_craft_moves.png", publicId: "blog/met_gala_craft_moves" },
];
...
async function main() {
    console.log(`Uploading Met Gala 2026 craft images to Cloudinary (${CLOUD_NAME})...\n`);
