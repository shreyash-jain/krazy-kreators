...
const images = [
    { path: path.join(root, 'wc_jersey_hero.jpg'), public_id: 'blog/wc_jersey_hero' },
    { path: path.join(root, 'wc_jersey_stadium.jpg'), public_id: 'blog/wc_jersey_stadium' },
    { path: path.join(root, 'wc_jersey_fabric_macro.jpg'), public_id: 'blog/wc_jersey_fabric_macro' },
    { path: path.join(root, 'wc_jersey_identity.jpg'), public_id: 'blog/wc_jersey_identity' },
];
