...
const images = [
    { path: path.join(root, 'nyfw_mens_2026_hero.jpg'), public_id: 'blog/nyfw_mens_2026_hero' },
    { path: path.join(root, 'nyfw_mens_2026_atelier.jpg'), public_id: 'blog/nyfw_mens_2026_atelier' },
    { path: path.join(root, 'nyfw_mens_2026_menswear.jpg'), public_id: 'blog/nyfw_mens_2026_menswear' },
    { path: path.join(root, 'nyfw_mens_2026_signals.jpg'), public_id: 'blog/nyfw_mens_2026_signals' },
];
