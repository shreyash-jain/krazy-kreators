...
export default function ContactClient() {
  ...
  useEffect(() => {
    const requiredFields = [
      ...
      'country',
      'services',
    ] as const satisfies ReadonlyArray<keyof ContactFormState>;

    const allRequiredFilled = requiredFields.every((fieldKey) =>
  ...
  return (
    <main className="w-full bg-[#FAF9F7]">
      ...
      <section className="py-28 sm:py-32 md:py-36">
        <div className="max-w-[95%] sm:max-w-[95%] md:max-w-[95%] lg:max-w-[80%] mx-auto px-6 md:px-20">
