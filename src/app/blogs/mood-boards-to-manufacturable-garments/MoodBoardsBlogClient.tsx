    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: "Discover the intricate process of transforming creative mood boards into production-ready garments that maintain design integrity while meeting manufacturing standards.",
                            ...
                            <div className="flex items-start gap-3 sm:gap-4">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="hidden sm:flex items-center gap-3 mb-3">
                                  ...
                                  <span className="text-sm text-[#666666] bg-gray-100 px-2 py-1 rounded-full">
                                    {comment.email}
                                  </span>
                                  <span className="text-sm text-[#666666]">•</span>
                                ...
                                <div className="flex flex-col gap-2 sm:hidden mb-3">
                                  ...
                                  <span className="text-xs text-[#666666] bg-gray-100 px-2 py-1 rounded-full self-start">
                                    {comment.email}
                                  </span>
                                </div>
                                
                                <div className="bg-[#F8F7F4] rounded-lg p-3 sm:p-4">
                                  <p className="text-[#2D2A2E] leading-relaxed text-sm sm:text-base break-words">
                                    {comment.comment}
                                  </p>
                                </div>
                              </div>
